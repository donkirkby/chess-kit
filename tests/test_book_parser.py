...
"""
        expected_tree = [ParagraphState(
            'Paragraph with <a href="https://example.com">example link</a>.')]
        tree = parse(source)
...
[second]: https://bogus.com
"""
        expected_tree = [ParagraphState(
            'Now <a href="https://example.com">two</a> '
            '<a href="https://bogus.com">links</a>.')]
        tree = parse(source)
    ...
    def test_bold(self):
        source = """\
Paragraph with heavily **emphasized text**.
"""
        expected_tree = [ParagraphState(
            'Paragraph with heavily <strong>emphasized text</strong>.')]
        tree = parse(source)
    ...
    def test_italic(self):
        source = """\
Paragraph with lightly *emphasized text*.
"""
        expected_tree = [ParagraphState(
            'Paragraph with lightly <em>emphasized text</em>.')]
        tree = parse(source)
